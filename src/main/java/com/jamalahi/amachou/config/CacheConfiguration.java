package com.jamalahi.amachou.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("amachou");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("amachou");
        ...
        config.getMapConfigs().put("com.jamalahi.amachou.domain.*", initializeDomainMapConfig(jHipsterProperties));
